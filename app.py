...
with tab1:
    ...
    with col1:
        ...
        beta = st.slider("Infection Rate (β)", 0.01, 1.0, 0.3, key="sir_beta")
    with col2:
        gamma = st.slider("Recovery Rate (γ)", 0.01, 1.0, 0.1, key="sir_gamma")
...
with tab4:
    ...
    if X is not None and y is not None:
        if st.button("Run ML Prediction"):
            ...
            st.download_button("💾 Download Predictions CSV", data=csv, file_name=f"{ml_choice}_prediction.csv", mime="text/csv")
